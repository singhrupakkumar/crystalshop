	...
	<div class="container">
    	<div class="row">
            <div class="col-sm-12 col-sm-offset-9">
              <?php if(!empty($articles)){  ?>  <span><a class="btn btn-success scss_grn" href="<?php echo $this->request->webroot.'articles/add'; ?>">Click here to add article</a></span><?php } ?>
            </div>    
                 <?php
                 if(!empty($articles)){  
        	...
        	<div class="col-sm-12">
            	<div class="detail_recnt">
                        <h4><a href="<?php echo $this->request->webroot; ?>articles/view/<?php  echo $article['id'];?>"><?php if(isset($article['title'])){ echo $article['title']; } ?></a> 
